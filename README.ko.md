...
솔직히 전 잘 모르겠습니다. 그냥 노래나 듣고 싶습니다. 그래서 **KILL//SILENCE**를 만들었습니다. with-agents 커멘드를 사용하면, Claude Code가 일하는 동안 음악을 틀어줍니다. 노래가 멈추면 다시 프롬프트를 입력해주세요. Claude가 다시 일하기 시작하면 노래가 다시 흘러나옵니다. 당신의 Spotify 계정을 연동해서, 세상 만사 귀찮은 사람들의 에이전틱 코딩을 경험하세요.
